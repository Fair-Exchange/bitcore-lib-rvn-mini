...
bitcore.versionGuard = function(version) {
  if (version !== undefined) {
    var message = 'More than one instance of bitcore-lib-rvn-mini found. ' +
      'Please make sure to require bitcore-lib-rvn-mini and check that submodules do' +
      ' not also include their own bitcore-lib-rvn-mini dependency.';
